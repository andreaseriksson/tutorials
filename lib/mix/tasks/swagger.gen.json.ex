defmodule Mix.Tasks.Swagger.Gen.Json do
  @shortdoc "Generates controller, views, and context for a JSON resource with swagger documentation"
  ...
  a `--table` option may be provided. For example:
      ...
      mix swagger.gen.json Accounts User users --table cms_users
  ...
  Read the documentation for `swagger.gen.schema` for more information on
  attributes.
  """
  ...
  def run(args) do
    if Mix.Project.umbrella?() do
      Mix.raise "mix swagger.gen.json can only be run inside an application directory"
    end
